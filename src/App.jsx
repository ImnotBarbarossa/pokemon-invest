...
// ═══════════════════════════════════════════════════════════════════
//  DECKS TCG POCKET — Top méta tournoi 2025 (20 cartes chacun)
//  Format TCG Pocket : 20 cartes exactement, max 2 exemplaires/carte
//  Pas d'énergie dans le deck (système d'énergie séparé)
// ═══════════════════════════════════════════════════════════════════
const DECKS = [
  { id:1, tier:"S", nom:"Pikachu ex / Électhor ex", type:"Électrik", winrate:"64%", couleur:"#f59e0b", emoji:"⚡",
    desc:"Le deck fondateur de la méta TCG Pocket. Pikachu ex impose 90 dégâts avec Thunderbolt, Électhor ex couvre avec 130 dégâts via Raging Thunder. Raichu et Voltali assurent la pression constante tout au long de la game.",
    forces:["Pikachu ex = 90 dégâts dès le tour 2","Électhor ex = 130 dégâts / counter aggro","Raichu complète la pression Électrik","Top 1 des tournois depuis le lancement"],
    faiblesses:["Électhor ex inflige 20 dégâts à soi-même","Vulnérable aux types Sol"],
    cartes:[
      { nom:"Pikachu ex",  nb:2, img:"", rarete:"Double Rare" },
      { nom:"Pikachu",     nb:2, img:"", rarete:"Commune"     },
      { nom:"Raichu",      nb:2, img:"", rarete:"Rare Holo"   },
      { nom:"Électhor ex", nb:2, img:"", rarete:"Double Rare" },
      { nom:"Voltali",     nb:2, img:"", rarete:"Rare Holo"   },
  ...
  { id:2, tier:"S", nom:"Mewtwo ex / Gardevoir", type:"Psy", winrate:"62%", couleur:"#e879f9", emoji:"🔮",
    desc:"La combinaison la plus explosive de la méta. Gardevoir génère 1 énergie Psy à chaque tour d'attaque, permettant à Mewtwo ex d'atteindre 150 dégâts très rapidement. Mew ex copie n'importe quelle attaque pour la flexibilité maximale.",
    forces:["Gardevoir accélère l'énergie Psy chaque tour","Mewtwo ex = jusqu'à 150 dégâts","Mew ex copie n'importe quelle attaque adverse","Bonbon Rare skip le Stade 1"],
    faiblesses:["Gardevoir = Stade 2 difficile à établir","Perte du starter = très handicapant"],
    cartes:[
      { nom:"Mewtwo ex",   nb:2, img:"", rarete:"Double Rare" },
      { nom:"Mew ex",      nb:2, img:"", rarete:"Double Rare" },
      { nom:"Gardevoir",   nb:2, img:"", rarete:"Rare Holo"   },
      { nom:"Kirlia",      nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Tarsal",      nb:2, img:"", rarete:"Commune"     },
      { nom:"Poké Ball",   nb:2, img:"", rarete:"Commune"     },
      { nom:"Pokédex",     nb:2, img:"", rarete:"Commune"     },
  ...
  { id:3, tier:"A+", nom:"Dracaufeu ex / Sulfura ex", type:"Feu", winrate:"58%", couleur:"#ef4444", emoji:"🔥",
    desc:"Dracaufeu ex inflige jusqu'à 200 dégâts avec Burning Darkness — la plus haute valeur de dégâts du format. Sulfura ex attaque dès le tour 1 et génère de l'énergie. Bonbon Rare skip le Stade 1 pour un setup immédiat.",
    forces:["Burning Darkness = 200 dégâts maximum","Sulfura ex = attaque tour 1 + accélération","Bonbon Rare = setup immédiat","Counter Plante et Acier"],
    faiblesses:["Dracaufeu = Stade 2, très lent","Mauvais départ = game lost"],
    cartes:[
      { nom:"Dracaufeu ex", nb:2, img:"", rarete:"Double Rare" },
      { nom:"Reptincel",    nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Salamèche",    nb:2, img:"", rarete:"Commune"     },
      { nom:"Sulfura ex",   nb:2, img:"", rarete:"Double Rare" },
      { nom:"Poké Ball",    nb:2, img:"", rarete:"Commune"     },
      { nom:"Pokédex",      nb:2, img:"", rarete:"Commune"     },
      { nom:"Bonbon Rare",  nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Auguste",      nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Giovanni",     nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Sacha",        nb:2, img:"", rarete:"Peu Commune" },
    ]},
  { id:4, tier:"A+", nom:"Dialga ex / Magnézone", type:"Métal", winrate:"56%", couleur:"#94a3b8", emoji:"⚙️",
    desc:"Dialga ex accumule la puissance avec Metal Blast — chaque énergie Métal augmente les dégâts. Magnézone fournit de l'accélération électrique. Registeel tank l'early game pendant que Dialga monte en puissance.",
    forces:["Metal Blast croît avec chaque énergie Métal","Magnézone = accélération + Electric Generator","Registeel = tank early game idéal","Très fort contre types Glace et Fée"],
    faiblesses:["Setup ultra lent (3 cartes évolution)","Faible contre types Feu et Combat"],
    cartes:[
      { nom:"Dialga ex",  nb:2, img:"", rarete:"Double Rare" },
      { nom:"Magnézone",  nb:2, img:"", rarete:"Rare Holo"   },
      { nom:"Magnéton",   nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Magnéti",    nb:2, img:"", rarete:"Commune"     },
      { nom:"Registeel",  nb:2, img:"", rarete:"Rare Holo"   },
      { nom:"Poké Ball",  nb:2, img:"", rarete:"Commune"     },
      { nom:"Pokédex",    nb:2, img:"", rarete:"Commune"     },
  ...
  { id:5, tier:"A", nom:"Palkia ex / Staross ex", type:"Eau", winrate:"53%", couleur:"#00b4d8", emoji:"💧",
    desc:"Palkia ex est dévastateur face aux decks chargés en banc avec Hydro Pump. Staross ex prend le relais rapidement avec Rapid Spin. Artikodin ex couvre les menaces Dragon et Plante. Ondine accélère l'énergie Eau.",
    forces:["Palkia ex = 60 + 20 par Pokémon adverse au banc","Staross ex setup en 1 seul tour","Artikodin ex = counter Dragon","Ondine attache 1-3 énergies Eau gratuitement"],
    faiblesses:["Palkia ex dépend du banc adverse","Vulnérable aux types Électrik"],
    cartes:[
      { nom:"Palkia ex",    nb:2, img:"", rarete:"Double Rare" },
      { nom:"Staross ex",   nb:2, img:"", rarete:"Double Rare" },
      { nom:"Stari",        nb:2, img:"", rarete:"Commune"     },
  ...
  { id:6, tier:"A", nom:"Arcanin ex / Sulfura ex", type:"Feu", winrate:"51%", couleur:"#f97316", emoji:"🔥",
    desc:"Deck Feu aggro ultra-rapide. Arcanin ex inflige 100 dégâts avec Flare Drive dès le tour 2. Sulfura ex monte la pression immédiatement. Auguste booste tous les Pokémon Feu pour des dégâts au maximum.",
    forces:["Arcanin ex = 100 dégâts dès le tour 2","Parmi les decks les plus rapides de la méta","Auguste = +30 dégâts à tous les Pokémon Feu","Triple menace Feu = contre Plante et Acier"],
    faiblesses:["Trois lignes évolution = peu consistant","Faible contre types Eau"],
    cartes:[
      { nom:"Arcanin ex", nb:2, img:"", rarete:"Double Rare" },
      { nom:"Caninos",    nb:2, img:"", rarete:"Commune"     },
      { nom:"Sulfura ex", nb:2, img:"", rarete:"Double Rare" },
      { nom:"Galopa",     nb:2, img:"", rarete:"Rare Holo"   },
      { nom:"Ponyta",     nb:2, img:"", rarete:"Commune"     },
      { nom:"Poké Ball",  nb:2, img:"", rarete:"Commune"     },
      { nom:"Pokédex",    nb:2, img:"", rarete:"Commune"     },
      { nom:"Auguste",    nb:2, img:"", rarete:"Peu Commune" },
      { nom:"Giovanni",   nb:2, img:"", rarete:"Peu Commune" },
...
const DECK_NAME_ALIAS = {
  // Noms français incorrects des anciens decks
  "Gréninjas": "Amphinobi",
  "Croâ":      "Grenousse",
  "Froakie":   "Grenousse",
  "Hyporoi":   "Trioxhydre",
